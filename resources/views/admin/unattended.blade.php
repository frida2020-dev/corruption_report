                        ...
                        <div class="fixed-table-body">
                            ...
                            <thead>
                                <tr>
                                    <th style="text-align: center; " colspan="10">
                                        <div class="th-inner ">  Unattended Complains</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                </tr>
                                <tr>
                                    <th class="bs-checkbox " style="vertical-align: siddle; width: 36px; " data-field="0" data-not-first-th="">
                                        <div class="th-inner ">
                                            <label>
                                    ...
                                    <th style="" data-field="sno">
                                        <div class="th-inner sortable both">Sno</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                    ...
                                    <th style="" data-field="names">
                                        <div class="th-inner sortable both">Names</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                    {{-- <th style="" data-field="refno">
                                        <div class="th-inner sortable both">RefNo</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                    ...
                                    <th style="" data-field="cont">
                                        <div class="th-inner sortable both">Tel</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                    <th style="" data-field="comment">
                                        <div class="th-inner sortable both">Insident Date</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                    ...
                                    <th style="" data-field="action">
                                        <div class="th-inner sortable both">Complain</div>
                                        <div class="fht-cell"></div>
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" data-index="0">
                                    ...
                                    {{-- <td style="">TEAMS20200813149</td>
                                    <td style="">Male</td> --}}
                                    <td style="">{{ $row->phone }}</td>
                                    <td style="">{{ $row->date_of_incident }}</td>
                                    <td style="">{{ $row->status }}</td>
                                    <td style="">{{ $row->complain }}</td>
                                </tr>
                                @endforeach
                            </tbody>   
                        </table>
