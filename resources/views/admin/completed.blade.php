...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Resolved Reports</li>
        </ol>
        

<div class="card mb-6">
<div class="container-fluid">
<div class="card-header"><i class="fa fa-desktop mr-1"></i>&nbsp; Resolved Reports</div>
<br><br>
